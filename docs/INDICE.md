...
| **[revisao-bee-1g-2026-09-04.md](revisao-bee-1g-2026-09-04.md)** | 🔴🔴 **revisão da cadeia inteira antes do run**: das 7 decisões, 1 rebaixada (T2 mediu bpb quando o plano mandava tradução; estágio único) e 5 com ressalvas. Acha o **corpus PT trancado no 32k**, o **buraco de dado de 13–53×** para o `pt-50`, o LR inexistente e a `seq_len` contraditória. 8 pré-requisitos, com custo |
| **[gate-sucesso-bee-1g.md](gate-sucesso-bee-1g.md)** | ⭐⭐ **o T4 declarado antes de gastar**: guardas que abortam, marcos programados, critérios no ponto final com **piso ao lado de cada linha** e *o que não mostra* escrito, critérios de parada, e o que o gate NÃO decide. Âncora do 350M a remedir na mesma régua |
